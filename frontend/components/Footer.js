        ...
        <div class="container d-flex flex-column">
          <div class="row social-icons">
            <div class="col d-flex justify-content-center">
              <ul class="d-flex">
                <li>
                  <a href="https://github.com/akassabian">
                    <svg
                      class="social-github"
                      version="1.1"
                      id="Layer_1"
                    ...
                    >
                      <path
                        ...
                        clip-rule="evenodd"
                        fill="#0F0C0D"
                        d="M422.399,3C203.499,3,25.999,180.477,25.999,399.425
                ...
                <li>
                  <a href="https://www.linkedin.com/in/alain-kassabian/">
                ...
                <li>
                  <a href="mailto:alainkassabian@gmail.com">
                    <svg
                      class="social-email"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
          ...
          <div class="row legal-text">
            <div class="col text-center">
              <p>&copy; {this.getYear()} Alain Kassabian.</p>
